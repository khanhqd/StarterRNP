...
export default class DatingScene extends Component {
              ...
              <TouchableOpacity
                ...
                style={{
                  ...
                  <View style={[styles.viewText,{flex: 3}]}>
                    <Text style={styles.text}>{data.dating_at}</Text>
                  </View>
                  <View style={[styles.viewText,{flex: 3}]}>
      ...
      <View style={styles.container}>
            ...
            style={{
              ...
              <View style={styles.firstRow}>
                  <View style={[styles.viewText, { flex: 3 }]}>
                    <Text
                    style={[styles.text, { fontWeight: 'bold', color:'white', fontSize:16}]}>Ngày hẹn</Text>
                  </View>
                  <View style={[styles.viewText,{flex: 3}]}>
                    <Text
